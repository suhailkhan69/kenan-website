...
const ReceptionStaffLogin = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://192.168.42.107:5001/reception/login', { email, password });
    ...
    <animated.div style={{ ...styles.container, ...containerSpring }}>
      ...
      <animated.div style={{ ...styles.right, ...rightSpring }}>
        <animated.div style={{ ...styles.formContainer, ...formSpring }}>
          <h2 style={styles.heading}>RECEPTION STAFF LOGIN</h2>
...
export default ReceptionStaffLogin;